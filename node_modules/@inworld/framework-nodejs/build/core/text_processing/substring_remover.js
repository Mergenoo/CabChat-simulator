...
class SubstringRemover extends stream_text_processor_1.StreamTextProcessor {
     ...
     * @param substrings - Vector of substrings to remove from the text
     * @returns Promise resolving to a new SubstringRemover instance
     * @throws InworldError if creation fails
     */
    static create(textStream, substrings) {
        return __awaiter(this, void 0, void 0, function* () {
            return stream_text_processor_1.StreamTextProcessor.createInstance(SubstringRemover, expose_binary_1.SubstringRemoverFunctions, expose_binary_1.StatusOrSubstringRemoverFunctions, textStream, substrings);
        });
    }
}
